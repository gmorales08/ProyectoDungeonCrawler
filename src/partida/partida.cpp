...
void Partida::generarListaEnemigos() {
    ...
    goblin.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::FUEGO);
    goblin.setProbabilidades({70,30});
    Enemigo esqueleto("Esqueleto", 2, Personaje::Elemento::HIELO);
    esqueleto.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::HIELO);
    esqueleto.setProbabilidades({70,30});
    Enemigo basilisco("Basilisco", 2, Personaje::Elemento::RAYO);
    basilisco.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::AGUA);
    basilisco.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::RAYO);
    basilisco.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::TIERRA);
    ...
    licantropo.getHabilidades().emplace_back(
        Habilidad::Tipo::OFENSIVA, Habilidad::Atributo::ATAQUE, 1);
    licantropo.setProbabilidades({70,30});
    Enemigo gargola("Gargola", 3, Personaje::Elemento::TIERRA);
    gargola.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::TIERRA);
    ...
    serpienteGigante.getHabilidades().emplace_back(
        Habilidad::Tipo::BUFF, Habilidad::Atributo::ATAQUE, 1);
    serpienteGigante.setProbabilidades({60,40});
    Enemigo hipocampo("Hipocampo", 4, Personaje::Elemento::AGUA);
    hipocampo.getHabilidades().emplace_back(
        Habilidad::Tipo::BUFF, Habilidad::Atributo::DEFENSAS, 1);
    ...
    panteraSalvaje.getHabilidades().emplace_back(
        Habilidad::Tipo::DEBUFF, Habilidad::Atributo::ATAQUES, 1);
    panteraSalvaje.setProbabilidades({60,40});
    Enemigo centauro("Centauro", 5, Personaje::Elemento::NEUTRO);
    centauro.getHabilidades().emplace_back(
        Habilidad::Tipo::DEBUFF, Habilidad::Atributo::DEFENSAS, 1);
    centauro.getHabilidades().emplace_back(
        Habilidad::Tipo::CURATIVA, 1);
    ...
    grifo.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::FUEGO);
    grifo.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::AGUA);
    grifo.getHabilidades().emplace_back(
    ...
    quimera.getHabilidades().emplace_back(
        Habilidad::Tipo::DEBUFF, Habilidad::Atributo::ATAQUES, 2);
    quimera.getHabilidades().emplace_back(
        Habilidad::Tipo::DEBUFF, Habilidad::Atributo::DEFENSAS, 2);
    ...
    manticora.getHabilidades().emplace_back(
        Habilidad::Tipo::DEBUFF, Habilidad::Atributo::DEFENSAS, 2);
    manticora.getHabilidades().emplace_back(
        Habilidad::Tipo::CURATIVA, 2);
    manticora.setProbabilidades({60,20,20});
    Enemigo yeti("Yeti", 7, Personaje::Elemento::HIELO);
    yeti.getHabilidades().emplace_back(
        Habilidad::Tipo::OFENSIVA, Habilidad::Atributo::ATAQUE, 2);
    yeti.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::HIELO);
    ...
    troll.getHabilidades().emplace_back(
        Habilidad::Tipo::OFENSIVA, Habilidad::Atributo::ATAQUE, 2);
    troll.getHabilidades().emplace_back(
        Habilidad::Tipo::BUFF, Habilidad::Atributo::ATAQUES, 2);
    troll.setProbabilidades({60,20,20});
    Enemigo minotauro("Minotauro", 8, Personaje::Elemento::TIERRA);
    minotauro.getHabilidades().emplace_back(
        Habilidad::Tipo::OFENSIVA, Habilidad::Atributo::ATAQUE, 2);
    minotauro.getHabilidades().emplace_back(
        Habilidad::Tipo::BUFF, Habilidad::Atributo::ATAQUES, 2);
    ...
    ciclope.getHabilidades().emplace_back(
        Habilidad::Tipo::BUFF, Habilidad::Atributo::DEFENSAS, 2);
    ciclope.getHabilidades().emplace_back(
        Habilidad::Tipo::CURATIVA, 2);
    ciclope.setProbabilidades({60,20,20});
    Enemigo golem("Golem", 9, Personaje::Elemento::TIERRA);
    golem.getHabilidades().emplace_back(
        Habilidad::Tipo::BUFF, Habilidad::Atributo::DEFENSAS, 2);
    golem.getHabilidades().emplace_back(
        Habilidad::Tipo::CURATIVA, 2);
    ...
    dragon.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::FUEGO);
    dragon.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::HIELO);
    dragon.getHabilidades().emplace_back(
    ...
    hidra.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::FUEGO);
    hidra.getHabilidades().emplace_back(
        Habilidad::Tipo::MAGIA, Personaje::Elemento::HIELO);
    hidra.getHabilidades().emplace_back(
